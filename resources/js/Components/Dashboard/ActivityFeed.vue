    ...
    <div class="card">
      ...
      <div class="card-header d-flex align-items-center">
        <div class="d-flex align-items-center">
          <a href="#">
            <img src="../../../src/assets/img/theme/team-1.jpg" class="avatar" />
          </a>
          <div class="mx-3">
      ...
      <div class="card-body">
        ...
        <img alt="Image placeholder" src="../../../src/assets/img/theme/img-1-1000x600.jpg" class="img-fluid rounded" />
            ...
            <div class="d-flex align-items-center justify-content-sm-end">
              <div class="avatar-group">
                <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                  ...
                  <img alt="Image placeholder" src="../../../src/assets/img/theme/team-1.jpg" class />
                </a>
                <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                  data-original-title="Audrey Love">
                  <img alt="Image placeholder" src="../../../src/assets/img/theme/team-2.jpg" class="rounded-circle" />
                </a>
                <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
                  data-original-title="Michael Lewis">
                  <img alt="Image placeholder" src="../../../src/assets/img/theme/team-3.jpg" class="rounded-circle" />
                </a>
              </div>
